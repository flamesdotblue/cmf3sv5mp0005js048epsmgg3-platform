...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[80vh] md:min-h-[90vh] overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center px-6 md:px-10 min-h-[80vh] md:min-h-[90vh]">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900">
            Life in Yoga
          </h1>
          <p className="mt-4 md:mt-6 text-lg md:text-xl text-slate-700">
            Science-guided yoga, meditation, and integrative health. Explore Measured Yoga Therapy, a data-informed approach that personalizes your practice.
          </p>
